...
However, if we wish to determine model performance, we should generate a whole bunch of predictions - preferably, thousands or even more - so that we can compute metrics like accuracy, or [loss](https://github.com/mobiletest2016/machine-learning-articles/blob/master/articles/about-loss-and-loss-functions.md). Great!
...
- In the second step, the predictions are compared with the "ground truth" (the real targets) - which results in the computation of a [loss value](https://github.com/mobiletest2016/machine-learning-articles/blob/master/articles/about-loss-and-loss-functions.md).
...
Do note the increasing validation loss, a clear [sign of overfitting](https://github.com/mobiletest2016/machine-learning-articles/blob/master/articles/what-is-dropout-reduce-overfitting-in-your-neural-networks.md).
...
- Save the best performing model instance (check ["How to save and load a model with Keras?"](https://github.com/mobiletest2016/machine-learning-articles/blob/master/articles/how-to-save-and-load-a-model-with-keras.md) - do note that this requires retraining because you haven't saved models with the code above), and use it for generating predictions.
